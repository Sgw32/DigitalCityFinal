...
<body>
  ...
  mysql_query('SET NAMES utf8;');
    ...
    if (isset($row["telephone"])){
        ...
        echo "<br>";
        echo "Здравствуйте ".$name."<br/> Вам начислено ".$b." баллов. ";

        $bally = $bally + $b;
        
        $r = mysql_query("UPDATE garbage SET bally='$bally' WHERE telephone='$telephone'");
        mysql_query('SET NAMES utf8;');

        $r1 = mysql_query("SELECT * FROM garbage WHERE telephone='$telephone'");
        mysql_query('SET NAMES utf8;');
        $row1 = mysql_fetch_array($r1);

    if (isset($row1["telephone"])){

      
          echo "Всего у Вас ".$row1["bally"]." баллов";
