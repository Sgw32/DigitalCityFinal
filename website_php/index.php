      ...
      <div class="feature-inner row">
        <div class="col-lg-2 col-md-6">
          <div class="feature-item d-flex">
            <i class="ti-book"></i>
            <div class="ml-20">
              <h4>Ученикам и родителям</h4>
              <p>
                Построение индивидуальной учебной траектории
              </p>
            </div>
          </div>
        </div>
        <div class="col-lg-2 col-md-6">
          <div class="feature-item d-flex">
            <i class="ti-cup"></i>
            <div class="ml-20">
              <h4>Школам, Колледжам, ВУЗам</h4>
              <p>
                Проведение совестный мероприятий 
              </p>
            </div>
          </div>
        </div>
